      ...
      >
        ...
        <ContentBox mode="Full">
          ...
          <ul>
            ...
            <li>
              <h3>Der Space hat keinen Platz für:</h3> Hochglanz,
              Überheblichkeit, Diskriminierung. Unser{" "}
              <a
        ...
        >
          ...
          <ul>
            ...
            <li>
              <h3>Frickelsamstag:</h3> Jeden 3. Samstag im Monat wird je nach
              Lage online oder offline im Space zusammen gefrickelt, Software
              und Hardware repariert und kaputt gemacht. Termin im Forum.
            </li>
            <li>
              <h3>f.u.c.k.:</h3> Kurz für FrauenNichtbinärTransInter Und
              Computer Kram. Feministisches Tech-Kollektiv mit Schwerpunkt
              Skillsharing, Verschlüsselung, digitale Selbstverteidigung.
            </li>
            <li>
        ...
        >
          <h2>Infrastruktur:</h2>
          <p>
            Neben dem Raum betreiben und bauen wir jede Menge Software. Ein
            großer Teil der von uns betriebenen Software ist kostenlos für Alle
            nutzbar. Ein paar Beispiele:
          </p>
          <ol>
            <li>BBB</li>
            <li>Pretix</li>
        ...
        >
          <h2>Mitmachen:</h2>
          <p>
            Eine Vereinsmitgliedschaft kostet 60€ im Jahr, bzw. ist kostenlos
          ...
          <Button
            label="Plenum"
            url="https://discuss.kalk.space/t/plenum/275"
          />
        </ContentBox>
      </Layout>
    </GenerativeStarBackground>
