      ...
      >
        ...
        <ContentBox mode="Full">
          ...
          <p>
            ...
            gegen Ware, unpersönlich, anonym, und mehr Teil des Vereins und
            Space werden.
          </p>
          <p>
            Deshalb erhoffen wir uns ein gewisses Maß an Interesse und Mitarbeit
            am/im Verein von allen Coworkenden. Und deswegen sind unsere
            Coworking Preise Mitgliedsbeiträge für den Verein. Austreten und
            dein Modell wechseln kannst du natürlich trotzdem monatlich.
          </p>
        </ContentBox>
        <ContentBox
          mode="Right"
        ...
        <ContentBox mode="Full">
          ...
          <p>
            Vielleicht. Wir versuchen natürlich, Dinge im Rahmen möglich zu
            machen und haben begrenzte Lagermöglichkeiten. Wertgegenstände
            sollten grundsätzlich nicht im Space gelagert werden.
          </p>
          <h3>Geht das Coworken auch ohne dieses Vereinsding?</h3>
          <p>
            Nein. Der Coworking Space IST der Verein. Als solches erhoffen wir
            uns ein gewisses Maß an Interesse und Mitarbeit am/im Vereinsleben
            von allen Coworkenden. Sonst funktioniert es halt nicht.
          </p>
        </ContentBox>
      </Layout>
    </GenerativeStarBackground>
