  ...
  return (
    ...
    >
      ...
      <ContentBox boxClassName={styles.mapBox}>
        <h2>Hallo Welt</h2>
        <p>
	  Der Kalkspace ist ein Ort, an dem wir uns treffen zum Austausch, miteinander 
	  arbeiten, Projekte verwirklichen, voneinander lernen. 
	  Wir bieten Raum für: Softwarefrickeln, Spieleabende, Schreibworkshops, Vorträge, gemeinsames Kochen,
	  Lerngruppen und vieles mehr.
	  Digitale Bildung bedeutet für uns Technik im Kontext von Gesellschaft zu betrachten und 
	  Machtverhältnisse zu hinterfragen.
	</p>
	<p>
	  Als Verein sind wir gemeinschaftlich organisiert. Wir freuen uns über Menschen, die Interesse haben
	  mitzugestalten. 
        </p>
